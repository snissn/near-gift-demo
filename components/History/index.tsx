...
import Widget from "@/components/History/Widget"
  ...
  return (
    <div className="fixed bottom-[20px] right-[20px]">
      ...
      <Popover.Root open={active} onOpenChange={toggleWidget}>
        ...
        <Popover.Content
          sideOffset={5}
          className="absolut bottom-[36px] -left-[10px] md:bottom-[64px] md:right-[20px] w-screen md:w-auto border-0 bg-transparent shadow-none"
        >
          <Widget />
        </Popover.Content>
      </Popover.Root>
